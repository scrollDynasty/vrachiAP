...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50/30 via-white to-green-50/20 relative overflow-hidden">
      {/* ОПТИМИЗАЦИЯ: Декоративные элементы только для мощных устройств */}
      {!isLowEndDevice && (
        <div className="absolute top-0 left-0 w-full h-full z-0 opacity-60">
          <div className="absolute top-20 left-[10%] w-64 h-64 rounded-full bg-gradient-to-r from-blue-300/15 to-indigo-300/15" />
          <div className="absolute bottom-20 right-[10%] w-80 h-80 rounded-full bg-gradient-to-r from-green-300/15 to-teal-300/15" />
          <div className="absolute top-1/3 right-[15%] w-40 h-40 rounded-full bg-gradient-to-r from-indigo-300/15 to-blue-300/15" />
          <div className="absolute bottom-1/4 left-[20%] w-56 h-56 rounded-full bg-gradient-to-r from-cyan-300/15 to-teal-300/15" />
        </div>
      )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 relative z-10">
        ...
        {/* ОПТИМИЗАЦИЯ: Верхняя часть - Поиск и иконки разделов */}
        ...
        {/* ОПТИМИЗАЦИЯ: Секция популярных направлений */}
        <motion.div 
          className="mb-16"
