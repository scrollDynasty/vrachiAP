...
const GlobalCallNotification = () => {
  ...
  if (outgoingCall) {
    return (
      <>
        {/* Уведомление о том что звоним */}
        <div className="fixed top-4 right-4 z-50">
          <Card className="bg-blue-600/90 border border-blue-400 shadow-2xl max-w-xs">
            <CardBody className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-white font-semibold text-sm">📞 Звонок идет...</p>
                  <p className="text-gray-300 text-xs">
